...
<body>
	...
	<table width="100%" border="0">
		<tr height="70" class="top">
			<td><a href="main" style="text-decoration: none"> <img
					src="<spring:url value ='/resources/img/LOGO.png'/>" height="70"
					alt="로고출력자리">
			...
			<td colspan="5">
				<div align="center">
					...
					<h4 class="green">Spring/MyBatis/Oracle/FrontControllPattern/Model2방식</h4>
				</div>
			</td>
 ...
 %>
		...
		<tr height="50">
			...
			<td align="center" width="16%" bgcolor="gray"><a href="list123"
