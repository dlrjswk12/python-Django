...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="bookListRForRent.jsp">
...
<jsp:include page="../common/top.jsp"></jsp:include>
	<div class="jumbotron jumbotron-info" style="background-color: white;">
			<h1><font color="black"><strong><label class="glyphicon glyphicon glyphicon-pencil"></label>대출관리</strong></font></h1>
                <!-- /.col-lg-12 -->
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                        	...
                                        	<th style="text-align: center;">대출신청인</th>
                                            <th style="text-align: center;">대출시작일</th>
                                        	<th style="text-align: center;">반납예정일</th>
                                            <th style="text-align: center;">대출승인/반납처리</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<c:forEach items="${dsBookList}" var="dsBookList" varStatus="bookIdx">
	                                        <tr>
	                                            ...
	                                            <td style="text-align: center; vertical-align: middle;">${dsBookList.USER_NM}</td>
	                                            ...
	                                            <td style="text-align: center; vertical-align: middle;">
	                                            	<button type="button" class="btn btn-primary" name ="rentBtn" onclick="fn_confirmRent('${dsBookList.RENT_NO}', '${dsBookList.BOOK_NAME}')">대출승인</button>
	                                            	<script type="text/javascript">
														if('${dsBookList.RENTAL_STATUS}' != '0'){
															$("button[name='rentBtn']").eq('${bookIdx.index}').prop("disabled", true);
														}
	                                            	</script>
			                         			   	<button type="button" class="btn btn-danger" name ="reserveBtn" onclick="fn_return('${dsBookList.RENT_NO}', '${dsBookList.USER_CODE}', '${dsBookList.BOOK_NAME}')">반납처리</button>
			                         			   	<script type="text/javascript">
														if('${dsBookList.RENTAL_STATUS}' != '1'){
