...
public interface BDao {
	...
	public void write(final String bBookname, final String bUrl, final String bContent, final long bPrice, final String bWriter, final String bPublisher, final String bCategory);
