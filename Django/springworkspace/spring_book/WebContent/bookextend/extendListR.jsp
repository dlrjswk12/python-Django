...
<head>
	<meta charset="UTF-8">
	<meta name="description" content="extendListR.jsp">
	...
	function fn_extend(paramRentNo, paramBookName){
		if(confirm('[' + paramBookName + ']을(를) 대출연장신청 하시겠습니까?')){
			location.href = "${context}/work/rent/updateExtend.do?rentNo=" + paramRentNo;
		}
	}
...
<jsp:include page="../common/top.jsp"></jsp:include>
	<div class="jumbotron jumbotron-info" style="background-color: white;">
			<h1><font color="black"><strong><label class="glyphicon glyphicon glyphicon-pencil"></label>대출연장신청</strong></font></h1>
                <!-- /.col-lg-12 -->
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;">신청가능여부</th>
                                            <th style="text-align: center;">연장신청</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                    	<c:forEach items="${dsBookList}" var="dsBookList" varStatus="bookIdx">
	                                        <tr>
	                                            ...
	                                            <td style="text-align: center; vertical-align: middle;">${dsBookList.EXTEND_NM}</td>
	                                            <td style="text-align: center; vertical-align: middle;">
	                                            	<button type="button" class="btn btn-primary" name ="extendBtn" onclick="fn_extend('${dsBookList.RENT_NO}', '${dsBookList.BOOK_NAME}')">대출연장신청</button>
	                                            	<script type="text/javascript">
														if('${dsBookList.EXTEND_YN}' == 'Y' || '${dsBookList.RESERVE_NO}' != ''){
															$("button[name='extendBtn']").eq('${bookIdx.index}').prop("disabled", true);
														}
	                                            	</script>
	                                            </td>
	                                        </tr>
